...
/** Validated append-only merchant-default values ready for persistence. */
public record AgentMerchantDefaultVersionDraft(Long tenantId, Long agentId, Integer versionNo,
                                               AgentMerchantDefaults defaults, LocalDateTime effectiveTime,
                                               LocalDateTime expiresTime, AgentMerchantDefaultStatus status,
