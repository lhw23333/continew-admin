...
/** Validated append-only pricing values ready for persistence. */
public record AgentPricingVersionDraft(Long tenantId, Long agentId, Long parentPricingVersionId, Integer versionNo,
                                       ...
                                       AgentPricingStatus status, Long createUser, LocalDateTime createTime) {
}
