...
/** KYC attachment metadata persistence entity. */
@Data
@TableName("biz_kyc_attachment")
public class KycAttachmentDO extends TenantBaseDO {
    ...
    private KycAttachmentScanStatus scanStatus;
    private KycAttachmentValidationStatus validationStatus;
