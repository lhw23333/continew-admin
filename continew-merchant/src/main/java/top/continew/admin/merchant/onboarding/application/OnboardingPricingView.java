...
/** Exact selected pricing version returned to the draft UI. */
public record OnboardingPricingView(Long kycVersionId, Long rowVersion, Long pricingVersionId, Integer versionNo,
