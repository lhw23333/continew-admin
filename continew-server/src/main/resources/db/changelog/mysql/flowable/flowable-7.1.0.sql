...
--changeset flowable:7.1.0.2-mysql-common splitStatements:true endDelimiter:;
...
--changeset flowable:7.1.0.2-mysql-engine splitStatements:true endDelimiter:;
...
--changeset flowable:7.1.0.2-mysql-history splitStatements:true endDelimiter:;
