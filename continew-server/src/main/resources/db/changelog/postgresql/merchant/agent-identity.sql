...
-- changeset continew:merchant-phase1-agent-promotion-code-postgresql
-- comment 代理商推广码独立状态与租户内唯一约束
ALTER TABLE "biz_agent"
    ADD COLUMN "promotion_code_status" varchar(32) NOT NULL DEFAULT 'DISABLED';
CREATE UNIQUE INDEX "uk_agent_promotion_code"
    ON "biz_agent" ("tenant_id", "promotion_code", "deleted");

-- changeset continew:merchant-phase1-agent-management-menu-postgresql
...
VALUES
(690000000000100000, '商户管理', 0, 1, '/merchant', 'Merchant', 'Layout', '/merchant/agent', 'shop', false, false,
 false, NULL, 4, 1, 1, NOW()),
(690000000000100100, '代理商管理', 690000000000100000, 2, '/merchant/agent', 'MerchantAgent',
 'merchant/agent/index', NULL, 'user-group', false, true, false, NULL, 1, 1, 1, NOW()),
(690000000000100101, '列表', 690000000000100100, 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
 'merchant:agent:list', 1, 1, 1, NOW()),
(690000000000100102, '详情', 690000000000100100, 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
 'merchant:agent:get', 2, 1, 1, NOW()),
(690000000000100103, '新增', 690000000000100100, 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
 'merchant:agent:create', 3, 1, 1, NOW()),
(690000000000100104, '修改', 690000000000100100, 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
 'merchant:agent:update', 4, 1, 1, NOW()),
(690000000000100105, '启停', 690000000000100100, 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
 'merchant:agent:lifecycle', 5, 1, 1, NOW()),
(690000000000100106, '重置密码', 690000000000100100, 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
 'merchant:agent:resetPassword', 6, 1, 1, NOW()),
(690000000000100107, '推广码', 690000000000100100, 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
 'merchant:agent:promotionCode', 7, 1, 1, NOW()),
(690000000000100108, '定价', 690000000000100100, 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
 'merchant:agent:pricing', 8, 1, 1, NOW()),
(690000000000100109, '商户默认', 690000000000100100, 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
 'merchant:agent:defaults', 9, 1, 1, NOW())
