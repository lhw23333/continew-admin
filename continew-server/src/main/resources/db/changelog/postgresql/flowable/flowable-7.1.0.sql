...
--changeset flowable:7.1.0.2-postgresql-common splitStatements:true endDelimiter:;
--comment Flowable 7.1.0.2 common schema copied unchanged from flowable-engine-common-7.1.0.jar
...
--changeset flowable:7.1.0.2-postgresql-engine splitStatements:true endDelimiter:;
--comment Flowable 7.1.0.2 process engine schema copied unchanged from flowable-engine-7.1.0.jar
...
--changeset flowable:7.1.0.2-postgresql-history splitStatements:true endDelimiter:;
--comment Flowable 7.1.0.2 process history schema copied unchanged from flowable-engine-7.1.0.jar
