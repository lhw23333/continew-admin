...
DROP TABLE IF EXISTS biz_channel_evidence_audit CASCADE;
DROP FUNCTION IF EXISTS biz_prevent_channel_evidence_audit_mutation() CASCADE;
...
DROP FUNCTION IF EXISTS biz_prevent_limit_adjustment_evidence_mutation() CASCADE;
