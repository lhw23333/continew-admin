...
DELETE FROM sys_role_menu WHERE menu_id BETWEEN 690000000000100200 AND 690000000000100206;
DELETE FROM sys_menu WHERE id BETWEEN 690000000000100200 AND 690000000000100206;
