...
/** Merchant-domain-owned state boundary used by channel event processing. */
public interface ChannelApplicationStatePort {
    Optional<ChannelApplicationState> lock(Long tenantId,
                                           Long applicationId,
                                           ChannelProductKey product,
                                           String configVersion);

    boolean apply(ChannelApplicationState current,
