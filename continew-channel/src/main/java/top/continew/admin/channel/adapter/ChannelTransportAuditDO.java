...
/** Append-only payload-free channel transport audit row. */
@Data
@TableName("biz_channel_transport_audit")
public class ChannelTransportAuditDO extends BaseIdDO {
    @Serial
    ...
    private ChannelTransportOutcome outcome;
